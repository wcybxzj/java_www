...
public class Demo00RegisterRuntimeException {
    // 1.使用数组保存已经注册过的用户名(数据库)
    static String[] usernames = {"张三","李四","王五"};

    public static void main(String[] args) throws RegisterRuntimeException {
        //2.使用Scanner获取用户输入的注册的用户名(前端,页面)
    ...
    //3.定义一个方法,对用户输入的中注册的用户名进行判断
    public static void checkUsername(String username) throws RegisterRuntimeException {
        //遍历存储已经注册过用户名的数组,获取每一个用户名
